...
namespace FayElf.Blog.Model
{
    ...
    /// </summary>
    [Table(Name = "ZW_Tb_Blog", PrimaryKey = "ID", ModelType = ModelType.Table, ConnName = "FayElf.Cube.Blog", ConnIndex = 0)]
    public class ZWTbBlogModel : Entity<ZWTbBlogModel>
	{
        #region 构造器
        /// <summary>
        /// 无参构造器
        /// </summary>
        public ZWTbBlogModel() { }
		#endregion
		...
		[Column(Name = "Title", PrimaryKey = false, AutoIncrement = false, DataType = "VARCHAR", DefaultValue = "", Description = "Title", IsNullable = false, Length = 300, Digit = 0, IsUnique = false, IsIndex = false, AutoIncrementSeed = 0, AutoIncrementStep = 0)]
        public String Title
        {
		...
		[DataObjectField(false, false, true, 0)]
		[Column(Name = "CatalogueID", PrimaryKey = false, AutoIncrement = false, DataType = "INTEGER", DefaultValue = "0", Description = "CatalogueID", IsNullable = true, Length = 0, Digit = 0, IsUnique = false, IsIndex = false, AutoIncrementSeed = 0, AutoIncrementStep = 0)]
        ...
        [Description("Hits")]
		[DataObjectField(false, false, true, 0)]
		[Column(Name = "Hits", PrimaryKey = false, AutoIncrement = false, DataType = "BIGINT", DefaultValue = "0", Description = "Hits", IsNullable = true, Length = 0, Digit = 0, IsUnique = false, IsIndex = false, AutoIncrementSeed = 0, AutoIncrementStep = 0)]
        public Int64? Hits
        {
		...
		/// 析构器
		/// </summary>
		~ZWTbBlogModel() { base.Dispose(true); }
		#endregion
	}
    #endregion
}